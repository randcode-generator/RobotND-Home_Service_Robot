...
sleep 5
xterm -e "cd ../.. && source devel/setup.bash && roslaunch pick_objects pick_objects.launch " &
sleep 5
xterm -e "cd ../.. && source devel/setup.bash && roslaunch add_markers add_markers.launch " &
